import{V as ve,N as fe,L as ge,G as be,M as g,S as se,R as l,B as v,J as P,D as f,t as a,b as K,y as ce,u as le,C as m,e as Y,d as ye,k as S,m as ie,O as E,g as q,a as oe,n as A,c as H,T as xe,F as Ce,l as ke,i as Se}from"./core-ACN954MB.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-CBv0dspj.js";import"./index-8WZbYVPO.js";import"./index.es-CwpWJJkT.js";import"./events-DQ172AOg.js";import"./index-DIwirM5T.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return fe(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},N=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
